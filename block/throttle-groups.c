 ...
 */
ThrottleState *throttle_group_new_legacy(const char *name, Error **errp)
{
    ThrottleGroup *tg;
 ...
 *
 * @name: the name of the ThrottleGroup. It must already exist.
 * @ret:  the ThrottleState member of the ThrottleGroup
 */
static ThrottleState *throttle_group_incref(const char *name)
{
